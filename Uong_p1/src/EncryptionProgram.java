...
public class EncryptionProgram {
	...
	public static void main(String[] args) {
		...
		/* Declaring integer variables for each digit of the four-digit integer 
		   and its encryption version. */
		...
		/* Prints out the encrypted integer to the user and then asks user
		   if they want to decrypt that integer. */
